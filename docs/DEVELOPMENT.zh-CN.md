...
> [项目首页](../README.zh-CN.md) | [English](DEVELOPMENT.md) | [BLE 配件 API 对接文档](LINKR_BLE_API.zh-CN.md)

本文集中说明固件构建与刷写、UART 集成、控制命令、测试模式、客户端工具、
通信协议和 Kconfig 配置。
...
[Linkr Bee 配件 API v1](LINKR_BLE_API.zh-CN.md)。
